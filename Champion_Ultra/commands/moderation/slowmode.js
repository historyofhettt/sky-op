...
module.exports = class Slowmode extends Command {
	constructor(client) {
      ...
      aliases: client.cmdConfig.slowmode.aliases,
			category: "moderation",
			enabled: client.cmdConfig.slowmode.enabled,
      slash: true,
      options: [{
        name: 'seconds',
